...
I jeszcze jedno. Jeżeli jesteś pracujesz w dużej, powszechnie znanej firmie lub instytucji, która posiada już liczną społeczność w innych serwisach i wciąż chcecie być obecni na Mastodonie pod swoją marką - rozważcie uruchomienie własnej instancji Mastodona pod jednoznacznie kojarzącym się adresem, tak jak robią to [instytucje Unii Europejskiej](https://social.network.europa.eu/), [Raspberry Pi](https://raspberrypi.social/), [Medium](https://medium.social/) i [zweryfikujcie jego własność](#no-dobrze-to-jak-przekonać-ludzi-że-jestem-osobą-za-którą-się-podaję). Uzyskacie w ten sposób pełną kontrolę nad swoimi danymi, będziecie mieć swobodę w wyznaczaniu zasad na Waszej instancji i skalowaniu serwera pod swoje potrzeby.
