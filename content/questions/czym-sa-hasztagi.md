...
Hasztag stanowi metadane Twoim wpisu, tj. dostarcza dodatkowych informacji, które nie stanowią treści wpisu, ale ułatwiają jego zrozumienie. Jeżeli masz styczność z programowaniem, pomyśl o hasztagu jak o komentarzu w kodzie.
...
Jeśli hasztag składa się z kilku słów, używaj wielkich liter - np. `#DepartamentWiedzyBezużytecznej` zamiast `#departamentwiedzybezużytecznej`. Dzięki temu czytniki ekranu poprawnie odczytają pojedyncze słowa w hasztagu i ułatwią jego zrozumienie osobom niewidomym lub słabo widzącym.
