...
Nazwa "Mastodon" pochodzi od [amerykańskiego zespołu heavy-metalowego](https://pl.wikipedia.org/wiki/Mastodon), ale jego identyfikacja wizualna nawiązuje do [prehistorycznego zwierzęcia](https://pl.wikipedia.org/wiki/Mastodonty).
